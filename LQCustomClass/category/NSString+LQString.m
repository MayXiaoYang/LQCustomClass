...
//13位时间戳转化为时间字符串
+ (NSString *)changeThirteenTimestampToTimeStringWith:(NSString *)timestampString withTimeFormatString:(NSString *)timeFormatterString{
    //格式化时间
    NSDateFormatter *formatter = [NSDateFormatter dateFormatterWithFormatter:timeFormatterString];
    NSDate *date = [NSDate dateWithTimeIntervalSince1970:[timestampString doubleValue] / 1000.0f];
    NSString *dateString = [formatter stringFromDate:date];
    return dateString;
}
//10位时间戳转化为时间字符串
+ (NSString *)changeTenTimestampToTimeStringWith:(NSString *)timestampString withTimeFormatString:(NSString *)timeFormatterString{
    NSDateFormatter *formatter = [NSDateFormatter dateFormatterWithFormatter:timeFormatterString];
